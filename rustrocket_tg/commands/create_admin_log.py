...
async def create_admin_log_group_async(
    group_name: str, write_env: bool = False
) -> None:
    ...
    try:
        ...
        with Progress(
            ...
            try:
                ...
                logger.info(
                    f"Created mega-group '{group_name}' with ID: {full_chat_id}"
                )
                ...
                bot_username = (
                    "RustRocketBot"  # This should be configurable or resolved
                )
                ...
                if bot_entity:
                    ...
                    await client(
                        functions.channels.InviteToChannelRequest(
                            channel=result.chats[0], users=[bot_entity]
                        )
                    )
...
def create_admin_log_command(
    ...
    write_env: bool = typer.Option(
        False, "--write-env", help="Update .env file with ADMIN_LOG_CHAT"
    ),
) -> None:
