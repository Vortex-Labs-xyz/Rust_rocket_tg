...
class TestCreateAdminLogCommand:
    ...
    def test_create_admin_log_without_bot_token(self, mock_pyperclip, mock_client, mock_settings_func):
    ...
    def test_create_admin_log_with_env_update(
        ...
        # Execute
        result = runner.invoke(app, ["create-admin-log", "--name", "Test Group", "--write-env"])
    ...
    @patch('rustrocket_tg.commands.create_admin_log.get_settings')
    @patch('rustrocket_tg.commands.create_admin_log.get_authenticated_client')
    def test_create_admin_log_telethon_error(self, mock_client_func, mock_settings_func, mock_settings):
